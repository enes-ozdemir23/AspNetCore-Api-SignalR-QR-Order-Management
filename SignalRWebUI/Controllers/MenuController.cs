...
namespace SignalRWebUI.Controllers
{
    ...
    public class MenuController : Controller
    {
        ...
        public async Task<IActionResult> AddBasket(int id ,int menuTableId)
        {
            ...
            var responseMessage = await client.PostAsync("https://localhost:7081/api/Basket", stringContent);

            var client2 = _httpClientFactory.CreateClient();
            await client2.GetAsync("https://localhost:7081/api/MenuTables/ChangeMenuTablesStatusToTrue?id="+ menuTableId);
